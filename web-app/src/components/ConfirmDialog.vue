    ...
    <Dialog class="relative z-50" @close="cancel">
      ...
      <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
          ...
          >
            <DialogPanel class="relative transform overflow-hidden rounded-lg bg-gray-900 ring-1 ring-white/10 px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:p-6">
